...
BEGIN_MESSAGE_MAP(CLeg_DebugApp, CWinApp)
...
// 僅有的一個 CLeg_DebugApp 物件

CLeg_DebugApp theApp;


// CLeg_DebugApp 初始設定

BOOL CLeg_DebugApp::InitInstance()
{
